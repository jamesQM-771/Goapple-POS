...
echo "<h2>Consumidor Virtualizado - GoApple POS (Arq. Cliente-Servidor - Semana 10)</h2>";
echo "<p>Consume los servicios registrados en el <em>service_registry.json</em> desde la BD real.</p>";
